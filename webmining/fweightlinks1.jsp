...
&nbsp;<b>FileName :</b></p></td>
<td colspan="7" background="index_files/ved_layout_2006_r5_c1.gif" valign="top">
<p align="center">&nbsp;<b>Meta Value :</b></p></td>
  </tr>
    ...
    <%
	 ...
	 double countval=0;
		rs1=st1.executeQuery("select * from metatable ");
	...
	%><tr>
    	...
    	<td colspan="7" background="index_files/ved_layout_2006_r5_c1.gif" valign="top"><b></b>&nbsp;<%= name %><br><br></td>
    
    <td colspan="7" background="index_files/ved_layout_2006_r5_c1.gif" valign="top">;<%= term %><br><br>	
    <%  
    	}
    	%>
